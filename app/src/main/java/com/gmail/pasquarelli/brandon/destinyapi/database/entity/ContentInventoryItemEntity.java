...
/**
 * This entity represents the DestinyInventoryItemDefinition table provided by Bungie in the
 * 'world_sql_content' database.
 */
@Entity(tableName = DatabaseStructure.CONTENT_INVENTORY_ITEMS_TABLE_NAME)
public class ContentInventoryItemEntity {
