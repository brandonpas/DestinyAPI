...
/**
 * This entity represents the DestinySandboxPerkDefinition table provided by Bungie in the
 * 'world_sql_content' database.
 */
@Entity(tableName = DatabaseStructure.CONTENT_SANDBOX_PERK_TABLE_NAME)
public class ContentSandboxPerkEntity {
    @PrimaryKey
    @NonNull
    public int id;
